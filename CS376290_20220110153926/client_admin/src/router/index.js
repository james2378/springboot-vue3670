...
const routes = [
	...
	// 课程资料路由
	{
		path: '/course_materials/table',
		name: 'course_materials_table',
		component: () => import('../views/course_materials/table.vue')
	},
	{
		path: '/course_materials/view',
		name: 'course_materials_view',
		component: () => import('../views/course_materials/view.vue')
	},
	// 学习统计路由
	{
		path: '/learning_statistics/table',
		name: 'learning_statistics_table',
		component: () => import('../views/learning_statistics/table.vue')
	},
	{
		path: '/learning_statistics/view',
		name: 'learning_statistics_view',
		component: () => import('../views/learning_statistics/view.vue')
	},

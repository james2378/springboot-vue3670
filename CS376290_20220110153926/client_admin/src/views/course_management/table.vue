	...
	<el-main class="bg">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="class_hours" label="学时"
				v-if="user_group == '管理员' || $check_field('get','class_hours')" min-width="200">
			</el-table-column>
			...
			<el-table-column prop="credit" label="学分"
				v-if="user_group == '管理员' || $check_field('get','credit')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/course_management/table','set') || $check_action('/course_management/view','set') || $check_action('/course_management/view','get') || $check_action('/资料/table','add') || $check_action('/资料/view','add')" >
				...
				<template slot-scope="scope">
					...
					<!--跨表按钮-->
					<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/course_materials/view')" v-if="user_group == '管理员' || $check_action('/course_materials/table','add') || $check_action('/course_materials/view','add')">
						<span>资料</span>
					</el-button>
				</template>
			</el-table-column>

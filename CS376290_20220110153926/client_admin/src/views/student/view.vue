<template>
	<el-main class="bg">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','college') || $check_field('add','college') || $check_field('set','college')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="学院" prop="college">
					<el-input id="college" v-model="form_sub['college']" placeholder="请输入学院"
							  v-if="user_group === '管理员' || (form_sub['student_id'] && $check_field('set','college')) || (!form_sub['student_id'] && $check_field('add','college'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','class_name') || $check_field('add','class_name') || $check_field('set','class_name')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="班级名称" prop="class_name">
					<el-input id="class_name" v-model="form_sub['class_name']" placeholder="请输入班级名称"
							  v-if="user_group === '管理员' || (form_sub['student_id'] && $check_field('set','class_name')) || (!form_sub['student_id'] && $check_field('add','class_name'))"></el-input>
